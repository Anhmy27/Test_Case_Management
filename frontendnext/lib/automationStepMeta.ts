...
export const ACTION_META: Record<string, ActionMeta> = {
  ...
  click: {
    ...
    targetTypes: ["css", "id", "text", "label", "testid", "role", "xpath"],
    targetPlaceholder: "#submit · Đăng nhập (text) · button (role) · //button[@id='ok']",
    valuePlaceholder: "",
    expectedPlaceholder: "",
  },
  type: {
    ...
    targetTypes: ["css", "id", "placeholder", "label", "testid", "xpath"],
    targetPlaceholder: "#email · Email (placeholder) · //input[@name='email']",
  ...
  select: {
    ...
    needsTarget: true, needsValue: true, needsExpected: false,
    targetTypes: ["css", "id", "label", "testid", "xpath"],
  ...
  waitFor: {
    ...
    needsTarget: true, needsValue: false, needsExpected: false,
    targetTypes: ["css", "id", "text", "testid", "role", "xpath"],
  ...
  assertText: {
    ...
    targetTypes: ["css", "id", "text", "testid", "label", "role", "xpath"],
  ...
  assertHidden: {
    ...
    needsTarget: true, needsValue: false, needsExpected: false,
    targetTypes: ["css", "id", "testid", "role", "xpath"],
  ...
  assertChecked: {
    ...
    needsTarget: true, needsValue: false, needsExpected: false,
    targetTypes: ["css", "id", "testid", "label", "role", "xpath"],
  ...
  press: {
    ...
    optionalTarget: true,
    needsTarget: false, needsValue: true, needsExpected: false,
    targetTypes: ["css", "id", "testid", "xpath"],
...
export const ALL_TARGET_TYPES = ["css", "id", "placeholder", "text", "label", "testid", "role", "xpath", "url"] as const;
